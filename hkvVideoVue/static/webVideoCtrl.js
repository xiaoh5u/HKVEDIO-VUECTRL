    ...
    var t = (function () {
      ...
      (GetSelectWndInfo = function (e) {
          ...
          re()
            ...
            : (_(
              ...
              M == e || R == e
                ...
                : q == e
                  ? m.I_StopRecord(t)
                  : L == e && m.I_StopVoiceTalk(),
              a.cbEvent && a.cbEvent(e, t, n));
        }),
        ...
        (e.KeyBoardEventInfo = function (e) {
          100 === parseInt(e, 10) &&
            ((l = !1), a.cbDoubleClickWnd && a.cbDoubleClickWnd(u, l));
        });
      var _ = function () {
        if (a.bDebugMode) {
          var e = E(arguments);
        ...
        F = function () {
          ...
          if (f.browser().msie)
            ...
            for (var t = navigator.mimeTypes.length, n = 0; t > n; n++)
              navigator.mimeTypes[n].type.toLowerCase() == a.szMimeTypes &&
                (e =
              ...
              success: function (t) {
                ...
                r.length > 0 &&
                  ...
                  (r = n
                    ...
                    .find("RacmCap")
                    .eq(0)
                    .find("isSupportMainAndSubRecord", !0)),
                  r.length > 0 &&
                  (e.bSupportSubStreamPlayback =
                    "true" ===
                    n
                      .$XML(t)
                      .find("RacmCap")
                      .eq(0)
                      .find("isSupportMainAndSubRecord")
                      .eq(0)
                      .text());
              }
            });
        ...
        J = function (e) {
          ...
          if (ee(e)) (s = K(e)), (t = s.iRtspPort), (r = s.iDevicePort);
            ...
            i
              ? (s = K(e))
              : ((s = Y(e)),
                -1 == s.iRtspPort && -1 == s.iDevicePort && (s = K(e))),
              (t = s.iRtspPort),
              (n = s.iHttpPort),
              (r = s.iDevicePort);
          }
        ...
        Y = function (e) {
          ...
          return (
            e.oProtocolInc.getUPnPPortStatus(e, {
              ...
              success: function (e) {
                for (
                  var o = n.$XML(e).find("portStatus", !0),
                  i = 0,
                  a = o.length;
                  a > i;
                  i++
              ...
              success: function (r) {
                "true" ==
                  ...
                  : e.oProtocolInc.getNetworkInterface(e, {
                    ...
                    success: function (e) {
                      for (
                        var r = n.$XML(e).find("NetworkInterface", !0),
                        s = 0,
                        o = r.length;
                        o > s;
                        s++
        ...
        ee = function (e) {
          ...
          return (
            e.oProtocolInc.getPPPoEStatus(e, {
              ...
              success: function (e) {
                t =
                  n.$XML(e).find("ipAddress", !0).length > 0
                    ? !0
                    : n.$XML(e).find("ipv6Address", !0).length > 0;
              },
              error: function () {
                t = !1;
              }
                  ...
                  (e.oStreamCapa.bObtained = !0),
                    ...
                    (e.oStreamCapa.bSupportShttpsPlaybackTransCode =
                      ...
                      n
                        ...
                        .eq(0)
                        .text()),
                    n.$XML(t).find("ipChanBase", !0).length > 0 &&
        ...
        ne = function (e) {
          ...
          var n = [];
          return (
            n.push("<?xml version='1.0' encoding='UTF-8'?>"),
        ...
        re = function () {
          if (a.bNoPlugin) {
            var e = f.browser();
            return !!(
              (e.chrome && parseInt(e.version, 10) > 45) ||
              (e.mozilla && parseInt(e.version, 10) > 52)
            );
          }
          return !1;
        },
      ...
      (this.I_InitPlugin = function (t, n, o) {
        ...
        (this.I_InsertOBJECTPlugin = function (t) {
          ...
          if (re()) {
            ...
            if ("" != u) {
              for (
                var l = {}, d = u.split(";"), p = "", P = 0, h = d.length;
                h > P;
                P++
              )
                (p = d[P]),
                  p.indexOf("sub-background") > -1
                    ? (l.background = p.split(":")[1])
                    : p.indexOf("sub-border-select") > -1
                      ? (l.borderSelect = p.split(":")[1])
                      : p.indexOf("sub-border") > -1 &&
                      (l.border = p.split(":")[1]);
              n.oStyle = l;
            }
            c = new JSPlugin(n);
          ...
          return null == c && null == c.object
            ...
            : ("object" == typeof e.attachEvent &&
              ...
              (c.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                ...
                c.attachEvent("RemoteConfigInfo", RemoteConfigInfo),
                c.attachEvent("KeyBoardEventInfo", KeyBoardEventInfo)),
              U(),
              0);
        }),
        ...
        (this.I_SetLocalCfg = function (e) {
          ...
          const replaceFuc = function(el){  
            let config = '' 
            if(t.hasOwnProperty(el)){ 
              config = t[el]
            }else{
              config = n.$XML(C).find(el).eq(0).text()
            }  
        ...
        f.extend(a, i),
          f.extend(a, {
            success: function (a) {
              ...
              (c.szIP = e),
                2 == t
                  ? ((c.szHttpProtocol = "https://"), (c.iHttpsPort = n))
                  : ((c.szHttpProtocol = "http://"), (c.iHttpPort = n)),
                (c.iCGIPort = n),
      ...
      (this.I_Login = function (t, r, s, o, i, a) {
        ...
        var l = h,
          p = S;
        if (
          (B(a.cgi) || (S == a.cgi ? ((l = h), (p = S)) : ((l = I), (p = v))),
            re())
        )
          if (S == p) {
            var P = {
              ...
              success: function (c) {
                ...
                f.extend(u, {
                  success: function (o) {
                    ...
                    (i.szIP = t),
                      2 == r
                        ? ((i.szHttpProtocol = "https://"),
                          (i.iHttpsPort = s))
                        : ((i.szHttpProtocol = "http://"), (i.iHttpPort = s)),
                      (i.iCGIPort = s),
                      ...
                      (i.sesstionTimer = setInterval(function () {
                        l.sessionHeartbeat(
                          ...
                          function () {
                            i.sessionFailed++,
                              i.sessionFailed >= 5 &&
                              (clearInterval(i.sesstionTimer),
                                e.PluginEventHandler(G, i.szDeviceIdentify));
                          }
                        );
                      }, 3e4)),
        ...
        (this.I_StartRealPlay = function (e, t) {
          ...
          if ((f.extend(P, t), -1 != r)) {
            ...
            var h = d[r];
            if (re()) {
              if (!h.bSupportWebsocket)
                return void (t.error && t.error(403, oe()));
              (s = h.oProtocolInc.CGI.startWsRealPlay),
                ...
                (c = P.iStreamType),
                (a =
                  P.iChannelID <= h.iAnalogChannelNum
                    ? P.iChannelID
                    : h.oStreamCapa.iIpChanBase +
              ...
              I == W && h.oStreamCapa.bSupportShttpPlay
                ? (_("SHTTP RealPlay"),
                  (s = h.oProtocolInc.CGI.startShttpRealPlay),
                  (o = "http://"),
                  (c = P.iStreamType - 1),
                  (a =
                    P.iChannelID <= h.iAnalogChannelNum
                  ...
                  (l = !0),
                  B(P.iPort)
                    ? "https://" == h.szHttpProtocol
                      ? (-1 == h.iHttpPort && (h.iHttpPort = J(h).iHttpPort),
                        (i = h.iHttpPort))
                      : (i = h.iCGIPort)
                    : ((h.iHttpPort = P.iPort), (i = P.iPort)))
                : (_("RTSP RealPlay"),
                  (s = h.oProtocolInc.CGI.startRealPlay),
                  (o = "rtsp://"),
                  (c = P.iStreamType),
                  (a = P.iChannelID),
                  B(P.iRtspPort) || (h.iRtspPort = P.iRtspPort),
                  -1 == h.iRtspPort && (h.iRtspPort = J(h).iRtspPort),
                  (i = h.iRtspPort));
            }
            if (-1 == i)
              return _("获取端口号失败"), void (t.error && t.error());
            if (
              (f.extend(P, {
                urlProtocol: o,
                cgi: s,
              ...
              if (re())
                h.oProtocolInc.startRealPlay(h, P).then(
                  function () {
                    r = this.findWndIndexByIndex(P.iWndIndex);
                    var e = p[r];
        ...
        (this.I_Stop = function (e) {
          ...
          if (-1 != n) {
            var r = p[n];
            if (
              (r.bRecord && (re() || c.HWP_StopSave(r.iIndex)),
                r.bSound && (re() || c.HWP_CloseSound()),
                r.bEZoom && (re() || c.HWP_DisableZoom(r.iIndex)),
                re())
            )
              c.JS_Stop(t.iWndIndex).then(
                function () {
        ...
        (this.I_OpenSound = function (e) {
          ...
          if (-1 != t) {
            var r = p[t];
            r.bSound ||
              ((n = re() ? c.JS_OpenSound(e) : c.HWP_OpenSound(e)),
                0 == n && (r.bSound = !0));
          }
          return n;
        }),
        (this.I_CloseSound = function (e) {
          ...
          if (-1 != t) {
            var r = p[t];
            r.bSound &&
              ((n = re() ? c.JS_CloseSound() : c.HWP_CloseSound()),
                0 == n && (r.bSound = !1));
          }
          return n;
        }),
        (this.I_SetVolume = function (e, t) {
          ...
          return (
            -1 != r &&
            (re()
              ? (c.JS_SetVolume(t, e), (n = 0))
              : (n = c.HWP_SetVolume(t, e))),
            n
          );
        }),
        (this.I_CapturePic = function (e, t) {
          ...
          if (-1 != r)
            if (re()) {
              var o = "JPEG";
              ".jpg" === e.slice(-4).toLowerCase()
                ? (e = e.slice(0, -4))
                : ".jpeg" === e.slice(-5).toLowerCase()
                  ? (e = e.slice(0, -5))
                  : ".bmp" === e.slice(-4).toLowerCase() &&
                  ((e = e.slice(0, -4)), (o = "BMP")),
        ...
        (this.I_StartRecord = function (e, t) {
          ...
          if (-1 != r) {
            ...
            if (s.bRecord) n.error && n.error();
              ...
              var o = f.browser();
              o.chrome
                ? c.JS_StartSave(n.iWndIndex, e).then(
                  function () {
          ...
          if (-1 != n) {
            ...
            if (r.bRecord)
              if (re()) {
                var s = f.browser();
                s.chrome
                  ? c.JS_StopSave(t.iWndIndex).then(
                    function () {
        ...
        (this.I_StartVoiceTalk = function (e, t) {
          ...
          if (-1 != n) {
            var s = d[n];
            s.bVoiceTalk ||
              ((r = re() ? -1 : s.oProtocolInc.startVoiceTalk(s, t)),
                0 == r && (d[n].bVoiceTalk = !0));
          }
          return r;
        }),
        ...
        (this.I_PTZControl = function (e, t, n) {
          ...
          if (-1 != s) {
            ...
            if (((s = this.findDeviceIndexByIP(o.szIP)), -1 != s)) {
              var i = d[s];
              9 == e
                ? i.oProtocolInc.ptzAutoControl(i, t, o, r)
                : i.oProtocolInc.ptzControl(i, t, o, r);
            }
          }
        }),
        (this.I_EnableEZoom = function (e) {
          ...
          if (-1 != t) {
            var r = p[t];
            r.bEZoom ||
              ((n = re() ? c.JS_EnableZoom(e) : c.HWP_EnableZoom(e, 0)),
                0 == n && (r.bEZoom = !0));
          }
          return n;
        }),
        (this.I_DisableEZoom = function (e) {
          ...
          if (-1 != t) {
            ...
            r.bEZoom &&
              (re()
                ? (n = c.JS_DisableZoom(e))
                : (c.HWP_DisableZoom(e), (n = 0)),
                0 == n && (r.bEZoom = !1));
          }
          return n;
        }),
        ...
        (this.I_Disable3DZoom = function (e) {
          ...
          if (-1 != t) {
            var r = p[t];
            r.b3DZoom &&
              (re() ? (n = -1) : (c.HWP_DisableZoom(e), (n = 0)),
                0 == n && (r.b3DZoom = !1));
          }
          return n;
        }),
          ...
          if ((f.extend(p, t), -1 != r)) {
            ...
            if (re()) {
              ...
              (s = P.oProtocolInc.CGI.startWsPlayback),
                ...
                (c = p.iStreamType),
                (a =
                  p.iChannelID <= P.iAnalogChannelNum
                    ? p.iChannelID
              ...
              h == W && P.oStreamCapa.bSupportShttpPlay
                ? ((s = B(p.oTransCodeParam)
                  ...
                  (a =
                    p.iChannelID <= P.iAnalogChannelNum
                      ...
                      P.iAnalogChannelNum -
                      1),
                  P.bSupportSubStreamPlayback && (a = 100 * a + c),
                  B(p.iPort)
                    ? "https://" == P.szHttpProtocol
                      ? (-1 == P.iHttpPort && (P.iHttpPort = J(P).iHttpPort),
                        (i = P.iHttpPort))
                      : (i = P.iCGIPort)
                    : ((P.iHttpPort = p.iPort), (i = p.iPort)))
                : ((s = P.oProtocolInc.CGI.startPlayback),
                  (o = "rtsp://"),
                  (c = p.iStreamType),
                  (a = 100 * p.iChannelID + c),
                  B(p.iRtspPort) || (P.iRtspPort = p.iRtspPort),
                  -1 == P.iRtspPort && (P.iRtspPort = J(P).iRtspPort),
                  (i = P.iRtspPort));
            }
            if (-1 == i)
              return _("获取端口号失败"), void (t.error && t.error());
            if (
              ...
              if (re())
                (p.szStartTime = p.szStartTime.replace(" ", "T") + "Z"),
                  ...
                  P.oProtocolInc.startPlayback(P, p).then(
                    function () {
                      t.success && t.success();
                    },
                    function () {
                ...
                (p.szStartTime =
                  p.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z"),
                  (p.szEndTime =
                    p.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z");
                var I = P.oProtocolInc.startPlayback(P, p);
                0 == I
                  ? t.success && t.success()
                  : ((P.iRtspPort = -1), t.error && t.error());
              }
          } else t.error && t.error();
        }),
        (this.I_ReversePlayback = function (e, t) {
          ...
          if ((f.extend(P, t), -1 != r)) {
            ...
            if (
              (I == W && h.oStreamCapa.bSupportShttpPlay
                ? ((o = h.oProtocolInc.CGI.startShttpReversePlayback),
                  (i = "http://"),
                  (l = P.iStreamType - 1),
                  (c =
                    P.iChannelID <= h.iAnalogChannelNum
                  ...
                  B(P.iPort)
                    ? "https://" == h.szHttpProtocol
                      ? (-1 == h.iHttpPort && (h.iHttpPort = J(h).iHttpPort),
                        (a = h.iHttpPort))
                      : (a = h.iCGIPort)
                    : ((h.iHttpPort = P.iPort), (a = P.iPort)))
                : ((o = h.oProtocolInc.CGI.startPlayback),
                  (i = "rtsp://"),
                  (l = P.iStreamType),
                  (c = 100 * P.iChannelID + l),
                  B(P.iRtspPort) || (h.iRtspPort = P.iRtspPort),
                  -1 == h.iRtspPort && (h.iRtspPort = J(h).iRtspPort),
                  (a = h.iRtspPort)),
                -1 == a)
            ...
            f.extend(P, {
              ...
              ((P.szStartTime =
                ...
                (P.szEndTime =
                  P.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z"),
                (s = h.oProtocolInc.reversePlayback(h, P)));
          }
        ...
        (this.yesterdayTime = function (format){ 
          var yest = new Date();
          yest.setTime(yest.getTime() - 24 * 60 * 60 * 1000);
          var year = yest.getFullYear(); //得到年份
          var month = yest.getMonth();//得到月份
          var date = yest.getDate();//得到日期
          var day = yest.getDay();//得到周几
          var hour = yest.getHours();//得到小时
          var minu = yest.getMinutes();//得到分钟
          var sec = yest.getSeconds();//得到秒
          month = month + 1;
          if (month < 10) month = "0" + month;
          if (date < 10) date = "0" + date;
          if (hour < 10) hour = "0" + hour;
        ...
        (this.I_Frame = function (e) {
          ...
          if (-1 != n) {
            ...
            if (s == D || s == T)
              if (re())
                c.JS_FrameForward(t.iWndIndex).then(
                  function () {
        ...
        (this.I_GetOSDTime = function (e) {
          ...
          if (-1 != n) {
            if (re())
              c.JS_GetOSDTime(t.iWndIndex).then(
                function (e) {
                  if (t.success) {
                    var n = f.dateFormat(
                      new Date(1e3 * e),
        ...
        (this.I_GetDownloadStatus = function (e) {
          ...
          return re()
            ? t
            : ((t = c.HWP_GetDownloadStatus(e)), 1 == t && (t = -1), t);
        }),
        ...
        (this.I_CheckPluginInstall = function () {
          ...
          if (re()) e = 0;
            ...
            for (var r = 0, s = navigator.mimeTypes.length; s > r; r++)
              if (
                "application/webvideo-plugin-kit" ==
        ...
        (this.I_ChangeWndNum = function (e) {
          return isNaN(parseInt(e, 10))
            ? -1
            : (re() ? c.JS_ArrangeWindow(e) : c.HWP_ArrangeWindow(e), 0);
        }),
        ...
        (this.I_DeviceCapturePic = function (e, t, n, r) {
          ...
          if (-1 != s) {
            ...
            if (
              (f.extend(a, r),
                !B(a.iResolutionWidth) && !f.isInt(a.iResolutionWidth))
            )
              return o;
            if (!B(a.iResolutionHeight) && !f.isInt(a.iResolutionHeight))
              return o;
      ...
      (ue.prototype.m_httpRequestSet = []),
        ...
        (ue.prototype.submitRequest = function () {
          ...
          if (re()) {
            ...
            this.options.async
              ? ((s.timeout = this.options.timeout),
            ...
            if (this.options.async) {
              ...
              var u = c.HWP_SendHttpSynRequest(
                i,
                this.options.url,
                this.options.auth,
                this.options.data,
        ...
        (ue.prototype.httpDataAnalyse = function (e, t) {
          ...
          "" == t || B(t)
            ? e.funErrorCallback()
            : ((r = parseInt(t.substring(0, 3))),
              (n = t.substring(3, t.length)),
              isNaN(r)
                ? e.funErrorCallback()
                : y == r
                  ? e.funSuccessCallback(f.loadXML2(n))
                  : e.funErrorCallback(r, f.loadXML2(n)));
        });
      var le = function () { };
      (le.prototype.CGI = {
          ...
          f.extend(o, t),
            f.extend(o, {
              success: function (e) {
                ...
                for (
                  var s = n.$XML(e).find("VideoInputChannel", !0),
                  o = 0,
                  i = s.length;
                  i > o;
                  o++
          ...
          f.extend(o, t),
            f.extend(o, {
              success: function (e) {
                ...
                for (
                  var s = n.$XML(e).find("InputProxyChannel", !0),
                  o = 0,
                  i = s.length;
                  i > o;
                  o++
          ...
          if (
            (this.getDigitalChannel(e, {
              ...
              success: function (e) {
                r = e;
                for (
                  var t = n.$XML(r).find("InputProxyChannel", !0),
                  o = 0,
                  i = t.length;
                  i > o;
                  o++
            ...
            f.extend(a, t),
              f.extend(a, {
                success: function (e) {
                  ...
                  for (
                    var o = n.$XML(e).find("InputProxyChannelStatus", !0),
                    i = 0,
                    a = o.length;
                    a > i;
                    i++
        ...
        (le.prototype.startRealPlay = function (e, t) {
          ...
          "rtsp://" === t.urlProtocol && (o = Z(o)),
            t.bZeroChannel
              ? (re() && (n = 0),
                (r = E(t.cgi.zeroChannels, t.urlProtocol, o, t.iPort, n)))
              : (r = E(t.cgi.channels, t.urlProtocol, o, t.iPort, n));
          var i = function () {
            var n = new ce();
          ...
          return (
            (s = c.HWP_Play(r, e.szAuth, t.iWndIndex, "", "")),
            0 == s && i(),
            s
          );
        }),
        ...
        (le.prototype.ptzAutoControl = function (e, t, n, r) {
          var s = n.iChannelID,
            ...
            i = "";
          if (
            ((r.iPTZSpeed = r.iPTZSpeed < 7 ? 15 * r.iPTZSpeed : 100),
              t && (r.iPTZSpeed = 0),
              e.szDeviceType != w)
          )
            (o =
              s <= e.iAnalogChannelNum
                ? E(
        ...
        (le.prototype.ptzControl = function (e, t, n, r) {
          ...
          o =
            (c != this.CGI.ptzFocus && c != this.CGI.ptzIris) ||
              ...
              : E(c.ipc, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID);
          var u = new ue(),
            l = {
              type: "PUT",
              url: o,
          ...
          f.extend(d, r),
            f.extend(d, {
              success: function (e) {
                ...
                // e = f.loadXML(t.join("")), 干你娘
                r.success && r.success(t.join(""))
              },
              error: function (e, t) {
                r.error && r.error(e, t);
              }
        ...
        (le.prototype.startPlayback = function (e, t) {
          var n = t.iWndIndex,
            ...
            i = e.szIP;
          if (
            ("rtsp://" === t.urlProtocol && (i = Z(i)),
              (r = re()
                ? E(t.cgi, t.urlProtocol, i, t.iPort, t.iChannelID)
                : E(t.cgi, t.urlProtocol, i, t.iPort, t.iChannelID, s, o)),
              !B(t.oTransCodeParam))
          ) {
        ...
        (le.prototype.startDownloadRecord = function (e, t) {
          var n = -1,
            ...
            s =
              ...
              f.escape(t.szPlaybackURI) +
              "</playbackURI></downloadRequest>";
          return (
            re()
              ? ((r = se(r)),
                (n = c.JS_StartDownload(r, e.szAuth, t.szFileName, s)))
              : (n = c.HWP_StartDownload(
                r,
                e.szAuth,
                t.szFileName,
                s,
        ...
        (le.prototype.deviceCapturePic = function (e, t, n, r) {
          var t = 100 * t + 1,
            ...
            i = [];
          if (
            (f.isInt(r.iResolutionWidth) &&
              i.push("videoResolutionWidth=" + r.iResolutionWidth),
              f.isInt(r.iResolutionHeight) &&
              i.push("videoResolutionHeight=" + r.iResolutionHeight),
              i.length > 0 && (o += "?" + i.join("&")),
              re())
          ) {
            var a = function (e, t) {
        ...
        (le.prototype.sessionLogin = function (e, t, r, s, o, i, a) {
          ...
          var u = E(this.CGI.sessionLogin, c, e, r),
            ...
            P = !1,
            h = "";
          n.$XML(i).find("isIrreversible", !0).length > 0 &&
            ((P =
              "true" ===
              n
                .$XML(i)
      ...
      (de.prototype.CGI = {
        ...
        getDigitalChannel:
          "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/DynVideo/inputs/channels",
        getDigitalChannelInfo:
          ...
          f.extend(o, t),
            f.extend(o, {
              success: function (e) {
                ...
                r.push("<InputProxyChannelList>");
                for (
                  var s = n.$XML(e).find("DynVideoInputChannel", !0),
                  o = 0,
                  i = s.length;
                  i > o;
                  o++
            ...
            f.extend(a, t),
              f.extend(a, {
                success: function (e) {
                  ...
                  r.push("<InputProxyChannelStatusList>");
                  for (
                    var o = n.$XML(e).find("DynVideoInputChannelStatus", !0),
                    i = 0,
                    a = o.length;
                    a > i;
                    i++
          ...
          f.extend(o, t),
            f.extend(o, {
              success: function (r) {
                ...
                for (
                  var o = n.$XML(r).find("AdminAccessProtocol", !0),
                  i = 0,
                  a = o.length;
                  a > i;
                  i++
        ...
        (de.prototype.startRealPlay = function (e, t) {
          ...
          "rtsp://" === t.urlProtocol && (s = Z(s)),
            (r = t.bZeroChannel
              ? E(t.cgi.zeroChannels, t.urlProtocol, s, t.iPort, n)
              : E(t.cgi.channels, t.urlProtocol, s, t.iPort, n));
        ...
        (de.prototype.startVoiceTalk = function (e, t) {
          var n = E(
            ...
            o = c.HWP_StartVoiceTalkEx(
              ...
              s,
              e.szAuth,
              e.iAudioTypeoDeviceInfo.m_iAudioBitRate,
              e.m_iAudioSamplingRate
            );
          return o;
        }),
        ...
        (de.prototype.setPreset = function (e, t, n) {
          ...
          (r = E(
            ...
            (s += "<id>" + n.iPresetID + "</id>"),
            e.szDeviceType != w &&
            (s += "<presetName>Preset" + n.iPresetID + "</presetName>"),
            (s += "</PTZPreset>");
          var o = new ue(),
            i = {
              type: "PUT",
            ...
            f.extend(d, {
              success: function (e) {
                ...
                t.push("<CMSearchResult>"),
                  ...
                  t.push("<matchList>");
                for (
                  var s = n.$XML(e).find("searchMatchItem", !0),
                  o = 0,
                  i = s.length;
                  i > o;
                  o++
        ...
        (de.prototype.deviceCapturePic = function (e, t, n, r) {
          ...
          return (
            f.isInt(r.iResolutionWidth) &&
            o.push("videoResolutionWidth=" + r.iResolutionWidth),
            f.isInt(r.iResolutionHeight) &&
            o.push("videoResolutionHeight=" + r.iResolutionHeight),
            o.length > 0 && (s += "?" + o.join("&")),
      ...
      (pe.prototype._alert = function (e) {
        ...
        (function (t) {
          ...
          (n.prototype.find = function (e, t) {
            var n = this.elems[this.length - 1]
            ...
            (n.prototype.eq = function (e, t) {
              var n = this.elems[this.length - 1].length,
                r = null;
              return (
                n > 0 && n > e && (r = this.elems[this.length - 1][e]),
            ...
            (n.prototype.attr = function (e) {
              if (this.elems[this.length - 1]) {
                var t = this.elems[this.length - 1].attributes.getNamedItem(
                  e
                );
                return t ? t.value : "";
              }
      ...
      (Pe.prototype.extend = function () {
        for (
          var e, t = arguments[0] || {}, n = 1, r = arguments.length;
          r > n;
          n++
        )
        ...
        (t.getIntegerBits = function (e, n, r) {
          ...
          for (a = Math.floor(n / 4); a <= Math.floor(r / 4); a++)
            i += o[a] && "" != o[a] ? o[a] : "0";
          return i;
        }),
      ...
      return (
        ...
        (f.createEventScript(
          ...
          f.createEventScript(
            o,
            "GetHttpInfo(lID, lpInfo, lReverse)",
            "GetHttpInfo(lID, lpInfo, lReverse);"
          ),
          f.createEventScript(
            o,
          ...
          f.createEventScript(
            o,
            "RemoteConfigInfo(lID)",
            "RemoteConfigInfo(lID);"
          ),
          f.createEventScript(
            o,
            "KeyBoardEventInfo(iKeyCode)",
            "KeyBoardEventInfo(iKeyCode);"
          )),
        this
      );
